...
const (
	// RabbitMQKey is the subkey used to load AWS configuration (e.g. AWSConfig)
	RabbitMQKey = "rabbitmq"
)

// NewRabbitMQConfig produces RabbitMQKey from Viper environment
func NewRabbitMQConfig(v *viper.Viper) (c *AWSConfig, err error) {
	c = new(AWSConfig)
